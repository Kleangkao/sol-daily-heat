    ...
    >
      <div className={embedded ? undefined : "mx-auto max-w-6xl"}>
        ...
        <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-3 md:hidden">
          {ISLANDDAO_FEATURED.map((partner) => (
            <FeaturedCard key={`mobile-${partner.id}`} partner={partner} fluid />
          ))}
        </div>

        <div className="featured-marquee-clip relative mt-3 hidden min-h-[76px] w-full max-w-full overflow-hidden py-1 md:block">
          <div
